...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims, n_actions, name, model_name,
                 chkpt_dir):
        ...
        self.checkpoint_file = os.path.join(self.checkpoint_dir, name+"_"+model_name)
