"""https://github.com/rssalessio/PyDeePC/blob/main/pydeepc/deepc.py"""
...
from controllers.DeePC2.utils import (
    Data,
    split_data,
...
class DeePC(object):
    ...
    def solve(
        ...
        try:
            result = self.optimization_problem.problem.solve(**cvxpy_kwargs, solver=cp.MOSEK)
        except cp.SolverError as e:
